...
void stateManagement() {
  ...
  case stateWelcomeScreen:
    ...
    stateText="\n\nWelcome to Turtle Script. \n\n\n"
      +"Here you can write a Turtle Script in an Editor and let the Turtle run it. \n"
      +"The Turtle carries a pen so it draws when it walks. \n"
      +"It is a 3D turtle so you can draw on the screen's surface but also dive into it.\n"
      +"You can also just play with the Turtle using cursor keys and other keys (Icon: Turtle with cursor keys).\n\n"
      +"In the Editor click the green > icon (or hit #) to run your Turtle Script,\nin run mode hit space to go back.\n"
  ...
  case stateManuallyHelp: 
    // The Help for the Turtle Script manually
